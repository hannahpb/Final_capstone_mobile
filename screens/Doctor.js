                ...
                <View style={{ marginTop: -50 }}>
                    <TouchableOpacity onPress={() => {navigation.navigate('DoctorOne')}}>
                        <View style={styles.container}>
                            ...
                            <View style={{ marginTop: -65, marginLeft: 100 }}>
                                <Text style={{ textAlign: 'left', color: 'white', fontWeight:'bold', fontSize: 18 }}>Dr. Michael Folly</Text>
                                <Text style={{ textAlign: 'left', fontSize: 14, color: 'white', fontWeight:'bold' }}>Residential Doctor</Text>
                                <Text style={{ textAlign: 'left', fontSize: 12, color: 'white', fontWeight:'bold' }}>Click Here for More Info</Text>
                            </View>
                        </View>
                    </TouchableOpacity>
                    <TouchableOpacity onPress={() => {navigation.navigate('DoctorTwo')}}>
                        <View style={styles.container}>
                            ...
                            <View style={{ marginTop: -65, marginLeft: 100 }}>
                                <Text style={{ textAlign: 'left', color: 'white', fontWeight:'bold', fontSize: 18 }}>Dr. Elizabeth Jones</Text>
                                <Text style={{ textAlign: 'left', fontSize: 14, color: 'white', fontWeight:'bold' }}>Residential Dentist</Text>
                                <Text style={{ textAlign: 'left', fontSize: 12, color: 'white', fontWeight:'bold' }}>Click Here for More Info</Text>
                            </View>
                        </View>
                    </TouchableOpacity>
